...
class VertexDrawingMixin:
    ...
    DX_DVertexCol = math.sqrt(3) * HexDrawingMixin.HEX_RADIUS / 2
    DY_DVertexCol = lambda d_col: - HexDrawingMixin.HEX_RADIUS / 2 if d_col % 2 == 1 else 0
    DX_DVertexRow = - math.sqrt(3) * HexDrawingMixin.HEX_RADIUS / 2
    DY_DVertexRow = 3 * HexDrawingMixin.HEX_RADIUS / 2

    def get_vertex_center(self, vertex):
        center_x, center_y = self.center
        center_vertex_x = center_x - math.sqrt(3) * HexDrawingMixin.HEX_RADIUS / 2
        center_vertex_y = center_y - HexDrawingMixin.HEX_RADIUS / 2
